    ...
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-white px-4 pt-[64px]">
        <div className="w-full max-w-lg text-center">
          <p className="section-label mb-4">Moto não encontrada</p>
          ...
          <p className="mt-6 text-[15px] leading-relaxed text-marine-500 md:text-[17px]">
            Esta moto pode ter sido vendida ou o link está incorreto.
            Confira nosso estoque completo para encontrar a moto ideal para você.
          </p>
